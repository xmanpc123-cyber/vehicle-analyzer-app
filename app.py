...
st.set_page_config(page_title="Vehicle Companion Analyzer", page_icon="🚘", layout="wide")
...
st.title("🚘 Vehicle Companion Analyzer")
...
with st.sidebar:
    ...
    target_province = st.text_input("หมวดจังหวัดเป้าหมาย", placeholder="เช่น สุราษฎร์ธานี")
